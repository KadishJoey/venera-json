...
class ConvertedSource_yyds_04_86b037 extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "http://www.yydsmh.com"
  };

  legadoRules = {
  "ruleSearchUrl": "http://www.yydsmh.com/search?searchkey=searchKey@Header:{Cookie=articlevisited=1}",
  "ruleSearchList": "id.js_comicSortList@li|\n.card|\n.comic-item",
  "ruleSearchName": "class.title@text|\n.card-title@text\n@js:\njava.put(\"name\",result);",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": "a@href",
  "ruleSearchCoverUrl": "img@src#https#http\n@js:\njava.put(\"img\",result);",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "class.chapter@text|\n.tags-list@text|\n.card-text@text",
  "ruleBookName": "",
  "ruleBookAuthor": "class.author@text",
  "ruleBookKind": "class.type@text",
  "ruleBookLastChapter": "",
  "ruleIntroduce": "id.js_desc_content@text",
  "ruleCoverUrl": "",
  "ruleChapterList": "id.js_chapters@li",
