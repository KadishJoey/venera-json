...
class ConvertedSource_source_16_d622ad extends ComicSource {
  name = "绅士会所";
  key = "source_16_d622ad";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.hentaiclub.net";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36", "Referer": "https://www.hentaiclub.net"};
  legadoRules = {"ruleSearchUrl":"https://www.hentaiclub.net/search/searchKey/","ruleSearchList":"div.item","ruleSearchName":".item-link-text@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"a.item-link@href","ruleSearchCoverUrl":"img.item-img@data-original|img.item-img@src","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":".post-info-text@text@js:result.split('\\n')[0]","ruleBookAuthor":"","ruleBookKind":".content a[href*=\"/tag/\"]@text","ruleBookLastChapter":"","ruleIntroduce":"","ruleCoverUrl":".post-item-img@data-original","ruleChapterList":"@js:[baseUrl]","ruleChapterName":"@js:'查看全文'","ruleChapterUrl":"","ruleContentUrl":"@js:result","ruleBookContent":".content img@data-original"};
