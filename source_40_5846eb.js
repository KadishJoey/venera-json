...
class ConvertedSource_source_40_5846eb extends ComicSource {
  name = "动漫啦";
  key = "source_40_5846eb";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "http://www.dongman.la";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.130 Safari/537.36", "Referer": "http://www.dongman.la"};
  legadoRules = {"ruleSearchUrl":"https://www.dongman.la/manhua/so/searchKey/searchPage.html","ruleSearchList":"class.cy_list_mh@tag.ul","ruleSearchName":"class.title@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"tag.a.0@href","ruleSearchCoverUrl":"tag.img@src@Header:{Referer:thisPage}","ruleSearchKind":"class.biaoqian@text#标签：","ruleSearchLastChapter":"class.updata@tag.a@text","ruleBookName":"class.cy_title@tag.h1@text","ruleBookAuthor":"class.cy_xinxi.0@tag.span.0@text#作者：","ruleBookKind":"class.cy_xinxi.1@tag.span.1@text&class.cy_xinxi.0@tag.font@text#类别：","ruleBookLastChapter":"class.cy_zhangjie_top@tag.a.0@text","ruleIntroduce":"id.comic-description@text","ruleCoverUrl":"class.cy_info_cover@tag.img@src@Header:{Referer:thisPage}","ruleChapterList":":_H006_kUVE/n25+OL0YW63RgX3vee1rzimhpPk7YVzjBMFcSI=\n","ruleChapterName":"tag.a@text","ruleChapterUrl":"","ruleContentUrl":"tag.a@href#www#m","ruleBookContent":":_H006_jLra4nV64zIM/5LdxYpfpVcXORpASqsSjQ+LVh72H3GyteOI1C+OpQJh4RSgmRw1\n"};
