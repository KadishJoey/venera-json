...
class ConvertedSource_source_40_5846eb extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "http://www.dongman.la"
  };

  legadoRules = {
  "ruleSearchUrl": "https://www.dongman.la/manhua/so/searchKey/searchPage.html",
  ...
  "ruleSearchKind": "class.biaoqian@text#标签：",
  "ruleSearchLastChapter": "class.updata@tag.a@text",
  "ruleBookName": "class.cy_title@tag.h1@text",
  "ruleBookAuthor": "class.cy_xinxi.0@tag.span.0@text#作者：",
  "ruleBookKind": "class.cy_xinxi.1@tag.span.1@text&class.cy_xinxi.0@tag.font@text#类别：",
  "ruleBookLastChapter": "class.cy_zhangjie_top@tag.a.0@text",
  "ruleIntroduce": "id.comic-description@text",
  "ruleCoverUrl": "class.cy_info_cover@tag.img@src@Header:{Referer:thisPage}",
  "ruleChapterList": ":_H006_kUVE/n25+OL0YW63RgX3vee1rzimhpPk7YVzjBMFcSI=\n",
  "ruleChapterName": "tag.a@text",
  "ruleChapterUrl": "",
  "ruleContentUrl": "tag.a@href#www#m",
  "ruleBookContent": ":_H006_jLra4nV64zIM/5LdxYpfpVcXORpASqsSjQ+LVh72H3GyteOI1C+OpQJh4RSgmRw1\n"
};
