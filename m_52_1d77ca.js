...
class ConvertedSource_m_52_1d77ca extends ComicSource {
  ...
  legadoRules = {
  "ruleSearchUrl": "https://m.kanman.com/api/getsortlist/?product_id=1&search_key=searchKey&page=searchPage&size=30&productname=kmh&platformname=wap",
  "ruleSearchList": "$.data.update[*].info[*]||$.data.data[*]||$.data[*]",
  "ruleSearchName": "$.comic_name",
  "ruleSearchAuthor": "$.comic_author",
  "ruleSearchNoteUrl": "https://m.kanman.com/api/getcomicinfo_body?comic_id={$.comic_id}&productname=kmh&platformname=wap",
  "ruleSearchCoverUrl": "http://image.mhxk.com/mh/{$.comic_id}.jpg-600x800.jpg.webp",
  "ruleSearchKind": "$.comic_type||$.sort_typelist@js:result.join().match(/[^(\\w+),\\|]+/g)",
  "ruleSearchLastChapter": "$.last_chapter_name||$.comic_chapter_name",
  "ruleBookName": "$.data.comic_name",
  "ruleBookAuthor": "$.data.comic_author",
  "ruleBookKind": "$.data.comic_type_new[*].name",
  "ruleBookLastChapter": "$.data.last_chapter_name",
  "ruleIntroduce": "$.data.comic_desc",
  "ruleCoverUrl": "$.data.cover_list[0]",
  "ruleChapterList": ":_H006_6Gtka62ys+1kJXUC+E5ocn41bK3SerXmauTL9F1Ekvc=\n",
  "ruleChapterName": "$.chapter_name@put:{chapter_id:$.chapter_id}",
  "ruleChapterUrl": "",
  "ruleContentUrl": "$.chapter_id@js:baseUrl+\"&chapter_id=\"+result",
  "ruleBookContent": ":_H006_\n"
};
