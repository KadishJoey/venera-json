...
class ConvertedSource_source_56_3ebb0b extends ComicSource {
  name = "漫蛙🌐🔞";
  key = "source_56_3ebb0b";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://manwa.me";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Linux; Android 10; HarmonyOS; PCT-AL10; HMSCore 6.5.0.312; GMSCore 20.15.16) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.105 HuaweiBrowser/12.1.0.302 Mobile Safari/537.36", "Referer": "https://manwa.me"};
  legadoRules = {"ruleSearchUrl":"https://manwa.me/search?keyword=searchKey@Header:{\"User-Agent\":\"Mozilla/5.0 (Linux; Android 10; HarmonyOS; PCT-AL10; HMSCore 6.5.0.312; GMSCore 20.15.16) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.105 HuaweiBrowser/12.1.0.302 Mobile Safari/537.36\"}","ruleSearchList":".manga-list li||.book-list li||$.books","ruleSearchName":"tag.p@text||.book-list-info-title@text||$.book_name||","ruleSearchAuthor":".book-list-info-bottom-item@text||$.author_name@js:result.replace(\"作者：\",\"\")","ruleSearchNoteUrl":"tag.a.0@href||$.id@js:\"https://manwa.me/book/\"+result.match(/\\d+/)","ruleSearchCoverUrl":".manga-list-2-cover-img@src||.book-list-cover-img@data-original||$.cover_url","ruleSearchKind":".book-list-info-bottom-right-font@text||$.tags","ruleSearchLastChapter":"$.last_chapter.chapter_name||$.last_chapter","ruleBookName":".detail-main-info-title@text","ruleBookAuthor":".detail-main-info-value@text","ruleBookKind":".detail-main-info-class a@text","ruleBookLastChapter":"id.detail-list-select@tag.a.-1@text","ruleIntroduce":".detail-desc@text","ruleCoverUrl":".detail-main-cover img@data-original","ruleChapterList":"id.detail-list-select@tag.a","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href","ruleBookContent":"@css:#cp_img img@data-r-src\n@Header:{Referer:thisPage}"};
