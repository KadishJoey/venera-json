...
class ConvertedSource_source_26_c5541c extends ComicSource {
  name = "腾讯漫画";
  key = "source_26_c5541c";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://m.ac.qq.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Android 9; Mobile; rv:68.0) Gecko/68.0 Firefox/68.0", "Referer": "https://m.ac.qq.com"};
  legadoRules = {"ruleSearchUrl":"https://m.ac.qq.com/search/result?word=searchKey","ruleSearchList":"class.comic-item","ruleSearchName":"class.comic-title@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"class.comic-link@href","ruleSearchCoverUrl":"class.comic-cover@tag.img@src","ruleSearchKind":"class.comic-tag@text","ruleSearchLastChapter":"class.comic-update@text#更新到?","ruleBookName":"li.head-info-title@h1@text","ruleBookAuthor":"li.author-wr@text","ruleBookKind":"","ruleBookLastChapter":"h1.mod-chapter-title@tag.span.0@text#^.*?已","ruleIntroduce":"class.head-info-desc@text","ruleCoverUrl":"div.head-banner@img@src","ruleChapterList":":_H006_y7Zpkw6hjU2CM+8YLBkOVn7wunWZDzfjkRo5dYqF/Oz5tU+ieDEuE0sONuYk6kEV\n","ruleChapterName":"tag.div.0@class&tag.span@text@js:result.replace(/comic-cover /g,'').replace(/\\n/g,'').replace(/lock/g,'💲')","ruleChapterUrl":"","ruleContentUrl":"href","ruleBookContent":":_H006_\n"};
