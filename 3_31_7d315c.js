...
class ConvertedSource_3_31_7d315c extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "https://comic.bh3.com"
  };

  legadoRules = {
  "ruleSearchUrl": "https://comic.bh3.com/book{,_error.html}",
  "ruleSearchList": "class.container",
  "ruleSearchName": "class.container-title@text",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": "id@js:\"https://comic.bh3.com/book/\"+result",
  "ruleSearchCoverUrl": "tag.img@src",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "",
  "ruleBookName": "class.title@text",
  "ruleBookAuthor": "@js:\"米忽悠\"",
  "ruleBookKind": "",
  "ruleBookLastChapter": "class.detail_info2_time@text#最近更新：",
  "ruleIntroduce": "class.detail_info1@text",
  "ruleCoverUrl": "class.cover@src",
  "ruleChapterList": ":_H006_MK2asNCy0H0kJ1tu8BI8qQAawUiKkQPqG33/FHyQra3WVOuICmAUSaAusTSFNJB2\n",
  "ruleChapterName": "$.title",
  "ruleChapterUrl": "",
  "ruleContentUrl": "https://comic.bh3.com/book/{$.bookid}/{$.chapterid}",
  "ruleBookContent": ":_H006_owxWyc4jG8XuD5YQ86+mwbAfBm6ze7Mnp8YS2O81l24=\n"
};
