...
class ConvertedSource_4khd_24_21d7d1 extends ComicSource {
  ...
  legadoRules = {
  "ruleSearchUrl": "https://www.4khd.com/search/searchKey/page/searchPage",
  "ruleSearchList": "li.wp-block-post",
  "ruleSearchName": ".fr-mobile-hide .wp-block-post-title a@text",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": ".fr-mobile-hide .wp-block-post-title a@href",
  "ruleSearchCoverUrl": ".wp-block-post-featured-image img@src@Header:{\"Referer\":\"https://www.4khd.com/\"}",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "",
  "ruleBookName": ".wp-block-post-title@text",
  "ruleBookAuthor": "",
  "ruleBookKind": "meta[property=\"og:type\"]@content",
  "ruleBookLastChapter": "",
  "ruleIntroduce": "meta[property=\"og:description\"]@content",
  "ruleCoverUrl": "meta[name=\"twitter:image\"]@content@Header:{\"Referer\":\"https://www.4khd.com/\"}",
  "ruleChapterList": ".wp-block-post-title, ul.page-links li.numpages a",
  "ruleChapterName": "text@js:/^\\d+$/.test(result) ? result : '1'",
  "ruleChapterUrl": "",
  "ruleContentUrl": "a@href@js:result ? result : baseUrl",
  "ruleBookContent": ".entry-content img@src@Header:{\"Referer\":\"https://www.4khd.com/\"}"
};
