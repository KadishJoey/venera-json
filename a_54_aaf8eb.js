...
class ConvertedSource_a_54_aaf8eb extends ComicSource {
  name = "A漫🔞";
  key = "a_54_aaf8eb";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://aman8.org";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36", "Referer": "https://aman8.org"};
  legadoRules = {"ruleSearchUrl":"https://aman8.org/cata.php?key=searchKey","ruleSearchList":"ul.hl-vod-list.clearfix@li","ruleSearchName":"a@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"a@href","ruleSearchCoverUrl":"a@data-original","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":"","ruleBookAuthor":"div.hl-data-xs.hl-text-muted@tag.span.1@text","ruleBookKind":"div.hl-data-xs.hl-text-muted@tag.span.2@text","ruleBookLastChapter":"","ruleIntroduce":"div.hl-data-xs.hl-text-muted@tag.span.3@text","ruleCoverUrl":"div.hl-dc-pic@span@data-original","ruleChapterList":"class.hl-col-xs-4 hl-col-sm-2","ruleChapterName":"a@text","ruleChapterUrl":"","ruleContentUrl":"a@href","ruleBookContent":"img@data-src"};
