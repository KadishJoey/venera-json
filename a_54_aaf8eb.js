...
class ConvertedSource_a_54_aaf8eb extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "https://aman8.org"
  };

  legadoRules = {
  "ruleSearchUrl": "https://aman8.org/cata.php?key=searchKey",
  "ruleSearchList": "ul.hl-vod-list.clearfix@li",
  "ruleSearchName": "a@text",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": "a@href",
  "ruleSearchCoverUrl": "a@data-original",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "",
  "ruleBookName": "",
  "ruleBookAuthor": "div.hl-data-xs.hl-text-muted@tag.span.1@text",
  "ruleBookKind": "div.hl-data-xs.hl-text-muted@tag.span.2@text",
  "ruleBookLastChapter": "",
  "ruleIntroduce": "div.hl-data-xs.hl-text-muted@tag.span.3@text",
  "ruleCoverUrl": "div.hl-dc-pic@span@data-original",
  "ruleChapterList": "class.hl-col-xs-4 hl-col-sm-2",
