...
class ConvertedSource_source_42_481e60 extends ComicSource {
  name = "漫漫漫画";
  key = "source_42_481e60";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.manmanapp.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:34.0) Gecko/20100101 Firefox/34.0", "Referer": "https://www.manmanapp.com"};
  legadoRules = {"ruleSearchUrl":"https://www.manmanapp.com/search/word-searchKey_searchPage.html","ruleSearchList":"class.mainBody@class.classification","ruleSearchName":"class.title@text","ruleSearchAuthor":"class.subtitle@text","ruleSearchNoteUrl":"tag.a.0@href","ruleSearchCoverUrl":"tag.img@src","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":"class.cartoon@class.title@text","ruleBookAuthor":"class.describe_title@tag.a.0@text","ruleBookKind":"class.describe_title@class.type@text#类型：","ruleBookLastChapter":"@js:String(java.getString(\"class.comic_list@tag.li.0@tag.h3@html\",false)).replace(/<(.*?)>.*/,\"$1\")","ruleIntroduce":"class.cartoon@class.describe@text#[展开]*$","ruleCoverUrl":"class.cartoon@tag.img@src","ruleChapterList":":_H006_\n","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href","ruleBookContent":":_H006_nPUsQ3UW7Chy66zQ8aOwfsgQy6YliSJ6lQ9bpdviV8Q=\n"};
