...
class ConvertedSource_mangaread_66_d1113a extends ComicSource {
  name = "MangaRead";
  key = "mangaread_66_d1113a";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.mangaread.org";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36", "Referer": "https://www.mangaread.org"};
  legadoRules = {"ruleSearchUrl":"https://www.mangaread.org?s=searchKey&post_type=wp-manga","ruleSearchList":".c-tabs-item__content|.page-item-detail","ruleSearchName":"h3@text","ruleSearchAuthor":".mg_author a@text","ruleSearchNoteUrl":"h3 a@href","ruleSearchCoverUrl":"tag.img@src","ruleSearchKind":".mg_genres a@text","ruleSearchLastChapter":"class.chapter.0@tag.a@text","ruleBookName":"h1@text","ruleBookAuthor":"//div[@class=\"author-content\"][1]/a/text()","ruleBookKind":"//div[@class=\"post-status\"][1]/div[2]/div[2]/text()&&//div[@class=\"genres-content\"][1]//a/text()","ruleBookLastChapter":"","ruleIntroduce":"//div[@class=\"summary__content show-more\"][1]/p/text()&&//div[@class=\"summary_content_wrap\"][1]/div[1]/div[1]/div[5]/div[2]/text()","ruleCoverUrl":"//div[@class=\"summary_image\"][1]/a/img/@src","ruleChapterList":"-//li[@class=\"wp-manga-chapter    \"]","ruleChapterName":"tag.a@text","ruleChapterUrl":"","ruleContentUrl":"tag.a@href","ruleBookContent":"//div[@class=\"page-break no-gaps\"]//img/@src"};
