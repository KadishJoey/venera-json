...
class ConvertedSource_source_45_d76464 extends ComicSource {
  name = "漫畫狗";
  key = "source_45_d76464";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://dogemanga.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.36 Edg/104.0.1293.70", "Referer": "https://dogemanga.com"};
  legadoRules = {"ruleSearchUrl":"https://dogemanga.com/?q=searchKey&o={{(searchPage-1)*12}}","ruleSearchList":"@js:\nvar list = [];\nif (/search/.test(baseUrl)) {\n  list = org.jsoup.Jsoup.parse(JSON.parse(result).results).select('.col-12').toArray()\n} else {\n  list = org.jsoup.Jsoup.parse(result).select('.col-12').toArray()\n}\nlist","ruleSearchName":"tag.h5@text","ruleSearchAuthor":"tag.h6@text","ruleSearchNoteUrl":"tag.a.0@href","ruleSearchCoverUrl":"tag.img@src","ruleSearchKind":"class.text-muted@text@js:String(result).match(/連載完結|連載中/)","ruleSearchLastChapter":"class.list-group-item.0@text","ruleBookName":"tag.h3@text","ruleBookAuthor":"tag.h4@text","ruleBookKind":"class.text-muted@text@js:String(result).match(/連載完結|連載中/)","ruleBookLastChapter":"class.vstack.0@text","ruleIntroduce":"class.text-truncate@text#.*?漫画\\s?，","ruleCoverUrl":"class.site-manga__cover-image@src","ruleChapterList":":_H006_mjRLJIe0sIGoiVSTVsQmTlVCVVv1pT2hYfhMKWy0EPrQNh71mIxKBo1JKksI2c7c\n","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"value","ruleBookContent":":_H006_zD03z1bB8NMi5916F2FsSK14JY/lPHs4E7pksfKBGWy7OZNF73Upesd5EoRlIr1k\n"};
