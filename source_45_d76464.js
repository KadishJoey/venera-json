...
class ConvertedSource_source_45_d76464 extends ComicSource {
  ...
  legadoRules = {
  "ruleSearchUrl": "https://dogemanga.com/?q=searchKey&o={{(searchPage-1)*12}}",
  ...
  "ruleSearchKind": "class.text-muted@text@js:String(result).match(/連載完結|連載中/)",
  "ruleSearchLastChapter": "class.list-group-item.0@text",
  "ruleBookName": "tag.h3@text",
  "ruleBookAuthor": "tag.h4@text",
  "ruleBookKind": "class.text-muted@text@js:String(result).match(/連載完結|連載中/)",
  "ruleBookLastChapter": "class.vstack.0@text",
  "ruleIntroduce": "class.text-truncate@text#.*?漫画\\s?，",
  "ruleCoverUrl": "class.site-manga__cover-image@src",
  "ruleChapterList": ":_H006_mjRLJIe0sIGoiVSTVsQmTlVCVVv1pT2hYfhMKWy0EPrQNh71mIxKBo1JKksI2c7c\n",
  "ruleChapterName": "text",
  "ruleChapterUrl": "",
  "ruleContentUrl": "value",
  "ruleBookContent": ":_H006_zD03z1bB8NMi5916F2FsSK14JY/lPHs4E7pksfKBGWy7OZNF73Upesd5EoRlIr1k\n"
};
