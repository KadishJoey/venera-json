...
class ConvertedSource_source_19_50ee2a extends ComicSource {
  name = "中国人能飞";
  key = "source_19_50ee2a";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.mh250.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36", "Referer": "https://www.mh250.com"};
  legadoRules = {"ruleSearchUrl":"https://www.mh250.com/b41?searchkey=searchKey","ruleSearchList":"div.classification","ruleSearchName":"h2 a@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"h2 a@href","ruleSearchCoverUrl":"img.tit_img@data-src|img.tit_img@src","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":"meta[property=\"og:novel:book_name\"]@content","ruleBookAuthor":"","ruleBookKind":"h1 .labelBox a@text","ruleBookLastChapter":"","ruleIntroduce":"p[id=worksDesc]@text","ruleCoverUrl":".ctdbLeft img@src","ruleChapterList":"ul.view-win-list li a","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href@js:'https://www.mh250.com'+result","ruleBookContent":"img.lazy@data-original"};
