...
class ConvertedSource_source_08_fa018e extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "http://mhbao.colacomic.com"
  };

  legadoRules = {
  "ruleSearchUrl": "http://mhbao.colacomic.com/search?searchkey=searchKey",
  "ruleSearchList": "li.comic-item",
  "ruleSearchName": "p.title@text",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": "a@href",
  "ruleSearchCoverUrl": "div.thumbnail img@src",
  "ruleSearchKind": "",
  ...
  "ruleChapterList": "[id=js_chapters] li.comic-chapter-item",
  "ruleChapterName": "a@text",
  "ruleChapterUrl": "",
  "ruleContentUrl": "a@href@js:d=String(result).match(/(\\d+)/g);'http://mhbao.colacomic.com/api/comic/read/pics@id='+d[1]+'&aid='+d[0]+'&offset=0&limit=10'",
  "ruleBookContent": "@JSon:$.data.pic[*].pic@Header:{\"User-Agent\":\"Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36\",\"Referer\":\"https://mhbao.colacomic.com/\"}"
};
