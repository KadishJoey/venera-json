...
class ConvertedSource_source_08_fa018e extends ComicSource {
  name = "野蛮漫画";
  key = "source_08_fa018e";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "http://mhbao.colacomic.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36", "Referer": "http://mhbao.colacomic.com"};
  legadoRules = {"ruleSearchUrl":"http://mhbao.colacomic.com/search?searchkey=searchKey","ruleSearchList":"li.comic-item","ruleSearchName":"p.title@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"a@href","ruleSearchCoverUrl":"div.thumbnail img@src","ruleSearchKind":"","ruleSearchLastChapter":"span.chapter@text","ruleBookName":"h1@text","ruleBookAuthor":"meta[property=\"og:novel:author\"]@content","ruleBookKind":"meta[property=\"og:novel:category\"]@content","ruleBookLastChapter":"","ruleIntroduce":"meta[property=\"og:description\"]@content","ruleCoverUrl":"meta[property=\"og:image\"]@content","ruleChapterList":"[id=js_chapters] li.comic-chapter-item","ruleChapterName":"a@text","ruleChapterUrl":"","ruleContentUrl":"a@href@js:d=String(result).match(/(\\d+)/g);'http://mhbao.colacomic.com/api/comic/read/pics@id='+d[1]+'&aid='+d[0]+'&offset=0&limit=10'","ruleBookContent":"@JSon:$.data.pic[*].pic@Header:{\"User-Agent\":\"Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36\",\"Referer\":\"https://mhbao.colacomic.com/\"}"};
