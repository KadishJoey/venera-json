...
class ConvertedSource_x_m_29_6ee1ce extends ComicSource {
  name = "x漫画-M";
  key = "x_m_29_6ee1ce";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.xmanhua.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Linux; Android 9; MIX 2 Build/PKQ1.190118.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36", "Referer": "https://www.xmanhua.com"};
  legadoRules = {"ruleSearchUrl":"https://www.xmanhua.com/search?title=searchKey&page=searchPage@Header:{Cookie:\"xmanhua_lang=2\"}","ruleSearchList":"@css:.manga-list>a","ruleSearchName":"@css:.manga-item-title@text","ruleSearchAuthor":"//p[2]/text()##作者：","ruleSearchNoteUrl":"href@Header:{Cookie:\"xmanhua_lang=2\"}","ruleSearchCoverUrl":"img@src","ruleSearchKind":"@css:.manga-item-subtitle>span@text","ruleSearchLastChapter":"","ruleBookName":"@css:.detail-main-top-info-title@text","ruleBookAuthor":"@css:.detail-main-info-author-item@text","ruleBookKind":"@css:.detail-main-top-info-class-item@text","ruleBookLastChapter":"//*[@id=\"tab-2\"]/div[2]/div[1]/a/text()","ruleIntroduce":"@css:#long@text","ruleCoverUrl":"@css:.detail-main-top-cover-img@src","ruleChapterList":":_H006_BB6ULgpxVv/JCG3OvcSJdYWG41J/v5bIXkDSxoQx2pc=\n","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href","ruleBookContent":":_H006_UxK6OSDp/pvRsMZWKmdJDxHxttmDJ7G5neLK1O+GDW5KEqUs3B6Kj6AWDVSSuqq7GPkvnNswS+mC\nJl8q5YW67BcOo+yTZcLVTm2yrY0NZPY=\n"};
