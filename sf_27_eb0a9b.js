...
class ConvertedSource_sf_27_eb0a9b extends ComicSource {
  name = "SF漫画";
  key = "sf_27_eb0a9b";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://mm.sfacg.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Android 9; Mobile; rv:68.0) Gecko/68.0 Firefox/68.0", "Referer": "https://mm.sfacg.com"};
  legadoRules = {"ruleSearchUrl":"https://mm.sfacg.com/ajax/Common.ashx?op=search@keyword=searchKey","ruleSearchList":"$.comics.*||$.data.*","ruleSearchName":"$.ComicName","ruleSearchAuthor":"$.AuthorName@put:{cid:ComicID}","ruleSearchNoteUrl":"https://mm.sfacg.com/b/{$.FolderName}","ruleSearchCoverUrl":"$.ComicCover","ruleSearchKind":"$.TypeName&&$.SerialStatus","ruleSearchLastChapter":"{$.LastChapterTitle}/{$.LastUpdateDate}","ruleBookName":"@css:.book_newtitle@text","ruleBookAuthor":"@css:.book_info3:eq(0)@text","ruleBookKind":"@css:.book_info2>span@text","ruleBookLastChapter":"","ruleIntroduce":"@css:.book_bk_qs1:nth-child(2)@text","ruleCoverUrl":"@css:.book_info>li>img@src","ruleChapterList":":_H006_sOeCKrYZuKP5CW0TmetongXPQh0XCF09bt5SBsqp3Hg=\n","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href#.*ZP\\/(.*?)\\/#https://comic.sfacg.com/Utility/@get:{cid}/ZP/$1.js","ruleBookContent":":_H006_ClcL6IMPkZ0d03KNMB3vOdfRBMelmfxuPv2W/m463QjbrWJjrReCVdhpZusU2klwGdrQh64NsQXd\nqmGb4C2R145cb/tap8MB86oILEoA0jRkjT3+BnBUOM3RkcJrLd9H\n"};
