...
class ConvertedSource_m_50_2be8b8 extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "https://m.manhuatai.com"
  };

  legadoRules = {
  "ruleSearchUrl": "https://m.manhuatai.com/api/getsortlist/?search_key=searchKey&page=searchPage&size=30&productname=mht&platformname=wap",
  "ruleSearchList": "$.data.update[*].info[*]||$.data.data[*]||$.data[*]",
  "ruleSearchName": "$.comic_name",
  "ruleSearchAuthor": "$.author_name",
  "ruleSearchNoteUrl": "https://m.manhuatai.com/api/getComicInfoBody?comic_id={$.comic_id}&productname=mht&platformname=wap",
  "ruleSearchCoverUrl": "https://image.mhxk.com/mh/{$.comic_id}.jpg-600x800.webp",
  ...
  "ruleChapterList": ":_H006_pKEyL7S8lsGmF6zvnAZounfJBBG0FcRWXi7UaU3bM0k=\n",
  "ruleChapterName": "$.chapter_name@put:{chapter_id:$.chapter_id}",
  "ruleChapterUrl": "",
  "ruleContentUrl": "https://m.manhuatai.com/api/getchapterinfov2?product_id=2&productname=mht&platformname=wap&comic_id=@get:{comic_id}&chapter_newid={$.chapter_id}&isWebp=1&quality=high",
  "ruleBookContent": ":_H006_hQhgMwlUt0dNRaO7G0nUDJAhtq6Nl6FXxsYRHRepUzweMNdPDXFjVv1/VQVPa/PmH7grpjUrGoUK\nfgRNVJp8XJRq8X/0rStOqxz/D0c3xjY=\n"
};
