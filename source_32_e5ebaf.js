...
class ConvertedSource_source_32_e5ebaf extends ComicSource {
  name = "漫画联合国";
  key = "source_32_e5ebaf";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.comicun.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:34.0) Gecko/20100101 Firefox/34.0", "Referer": "https://www.comicun.com"};
  legadoRules = {"ruleSearchUrl":"https://www.comicun.com/search-index?entry=1&ie=gbk&q=searchKey&page=searchPage","ruleSearchList":"id.dmList@tag.li","ruleSearchName":"tag.a.2@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"tag.a.0@href","ruleSearchCoverUrl":"tag.img@src","ruleSearchKind":"tag.dd@tag.p.2@tag.a@text","ruleSearchLastChapter":"tag.a.1@text#^\\D+\\s*(\\d+話)#$1","ruleBookName":"class.title@tag.h1@text","ruleBookAuthor":"class.info@tag.p.1@tag.a@text","ruleBookKind":"class.info@tag.p.4@tag.a@text","ruleBookLastChapter":"class.title@tag.span@text#^\\D+\\s*(\\d+話)#$1","ruleIntroduce":"class.introduction@text","ruleCoverUrl":"","ruleChapterList":":_H006_IqnqoXC/7AgyIAC/ZP6wFGCSnRJqp6VGDUC+qW0UQ0c=\n","ruleChapterName":"tag.a@text#^\\D+\\s*(\\d+話)#$1","ruleChapterUrl":"","ruleContentUrl":"tag.a@href","ruleBookContent":":_H006_lQpnt8ucHv50mQTMZ7CC6g==\n"};
