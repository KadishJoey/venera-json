...
class ConvertedSource_source_20_d2b98b extends ComicSource {
  ...
  legadoRules = {
  "ruleSearchUrl": "https://www.wnacg.com/search/?q=searchKey&f=_all&s=create_time_DESC&syn=yes&p=searchPage",
  ...
  "ruleChapterUrl": "",
  "ruleContentUrl": "href@js:'https://www.wnacg.com'+result.replace('slide','gallery').replace('list','gallery')",
  "ruleBookContent": "@js:result.match(/(?:https?:)?\\/\\/[\\w.-]+\\/(?:data|t)\\/[^\"'\\s]+\\.(?:jpg|jpeg|png|gif|webp)/g).map(function(u){return u.indexOf('http')===0?u:'http:'+u})"
};
