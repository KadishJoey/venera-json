...
class ConvertedSource_source_20_d2b98b extends ComicSource {
  name = "紳士漫畫🔞🌐";
  key = "source_20_d2b98b";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.wnacg.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36", "Referer": "https://www.wnacg.com"};
  legadoRules = {"ruleSearchUrl":"https://www.wnacg.com/search/?q=searchKey&f=_all&s=create_time_DESC&syn=yes&p=searchPage","ruleSearchList":"li.gallary_item","ruleSearchName":"a@title@js:result.replace(/<\\/?em>/g,'')","ruleSearchAuthor":"","ruleSearchNoteUrl":"a@href","ruleSearchCoverUrl":"img@src@js:result.replace(/^\\/+/,'http://')","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":"h2@text","ruleBookAuthor":"","ruleBookKind":"label@text","ruleBookLastChapter":"","ruleIntroduce":".addtags@text","ruleCoverUrl":".uwthumb img@src@js:result.replace(/^\\/+/,'http://')","ruleChapterList":"a[href*='photos-slide-aid-'] | a[href*='photos-list-aid-']","ruleChapterName":"@js:'正文'","ruleChapterUrl":"","ruleContentUrl":"href@js:'https://www.wnacg.com'+result.replace('slide','gallery').replace('list','gallery')","ruleBookContent":"@js:result.match(/(?:https?:)?\\/\\/[\\w.-]+\\/(?:data|t)\\/[^\"'\\s]+\\.(?:jpg|jpeg|png|gif|webp)/g).map(function(u){return u.indexOf('http')===0?u:'http:'+u})"};
