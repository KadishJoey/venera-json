...
class ConvertedSource_8_23_b711ea extends ComicSource {
  ...
  legadoRules = {
  "ruleSearchUrl": "https://8se.me/photos/keyword-searchKey.html",
  "ruleSearchList": ".item.photo",
  "ruleSearchName": ".title@text",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": "a[href*=\"photo/id-\"]@href@js:'https://8se.me'+result",
  "ruleSearchCoverUrl": ".item.photo .img@style@js:result.split(\"url('\")[1].split(\"'\")[0]",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "",
  "ruleBookName": ".photo-image a@title",
  "ruleBookAuthor": "",
  "ruleBookKind": "",
  "ruleBookLastChapter": "",
  "ruleIntroduce": "",
  "ruleCoverUrl": ".photo-image .img@style@js:result.split(\"url('\")[1].split(\"'\")[0]",
  "ruleChapterList": ".photo-image",
  "ruleChapterName": ".tags div@text",
  "ruleChapterUrl": "",
  "ruleContentUrl": "a[href*=\"photoShow\"]@href@js:'https://8se.me'+result",
  "ruleBookContent": "link[rel=preload][as=image]@href@Header:{\"Referer\":\"https://8se.me/\"}"
};
