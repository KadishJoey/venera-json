...
class ConvertedSource_8_23_b711ea extends ComicSource {
  name = "8色摄影";
  key = "8_23_b711ea";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://8se.me";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1", "Referer": "https://8se.me"};
  legadoRules = {"ruleSearchUrl":"https://8se.me/photos/keyword-searchKey.html","ruleSearchList":".item.photo","ruleSearchName":".title@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"a[href*=\"photo/id-\"]@href@js:'https://8se.me'+result","ruleSearchCoverUrl":".item.photo .img@style@js:result.split(\"url('\")[1].split(\"'\")[0]","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":".photo-image a@title","ruleBookAuthor":"","ruleBookKind":"","ruleBookLastChapter":"","ruleIntroduce":"","ruleCoverUrl":".photo-image .img@style@js:result.split(\"url('\")[1].split(\"'\")[0]","ruleChapterList":".photo-image","ruleChapterName":".tags div@text","ruleChapterUrl":"","ruleContentUrl":"a[href*=\"photoShow\"]@href@js:'https://8se.me'+result","ruleBookContent":"link[rel=preload][as=image]@href@Header:{\"Referer\":\"https://8se.me/\"}"};
