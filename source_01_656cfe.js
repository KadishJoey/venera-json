...
class ConvertedSource_source_01_656cfe extends ComicSource {
  name = "漫画家📱⛅";
  key = "source_01_656cfe";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "http://mhjia.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0", "Referer": "http://mhjia.com"};
  legadoRules = {"ruleSearchUrl":"https://mhjia.com/e/search/index.php?keyboard=searchKey&show=title,writer,byr&searchget=1","ruleSearchList":"class.col-md-3 col-sm-6 col-xs-6 home-truyendecu","ruleSearchName":"a@title","ruleSearchAuthor":"","ruleSearchNoteUrl":"a@href","ruleSearchCoverUrl":"img@src","ruleSearchKind":"","ruleSearchLastChapter":"class.chi-tiet tt-status@text#New#","ruleBookName":"","ruleBookAuthor":".info-chitiet@a[itemprop='author']@text","ruleBookKind":".info-chitiet@a[itemprop='genre']@text","ruleBookLastChapter":"","ruleIntroduce":"class.desc-text@text","ruleCoverUrl":"class.book@img@src","ruleChapterList":".light-off-list .list-chapter li","ruleChapterName":"a@text","ruleChapterUrl":"","ruleContentUrl":"a@href","ruleBookContent":"img@data-original"};
