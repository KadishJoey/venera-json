...
class ConvertedSource_source_07_49effa extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "http://www.zcymh.com"
  };

  legadoRules = {
  "ruleSearchUrl": "http://www.zcymh.com/search?searchkey=searchKey",
  "ruleSearchList": "id.js_comicSortList@li||$.data",
  "ruleSearchName": "class.title@text||$.name",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": "a@href||$.info_url",
  "ruleSearchCoverUrl": "class.img@src||$.cover",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "class.chapter@text||$.lastchapter",
  "ruleBookName": "",
  "ruleBookAuthor": "class.name@class.author@text",
  "ruleBookKind": "class.type@text",
  "ruleBookLastChapter": "",
  "ruleIntroduce": "id.js_desc_content@text",
  "ruleCoverUrl": "class.thumbnail@tag.img@src",
  "ruleChapterList": "id.js_chapters@li",
  "ruleChapterName": "a@text",
  "ruleChapterUrl": "",
  "ruleContentUrl": "a@href",
  "ruleBookContent": "class.item@tag.img@data-src@Header:{Referer:\"http://zcymh.com/\"}"
};
