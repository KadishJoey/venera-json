...
class ConvertedSource_source_07_49effa extends ComicSource {
  name = "☄️ 最次元";
  key = "source_07_49effa";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "http://www.zcymh.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36", "Referer": "http://www.zcymh.com"};
  legadoRules = {"ruleSearchUrl":"http://www.zcymh.com/search?searchkey=searchKey","ruleSearchList":"id.js_comicSortList@li||$.data","ruleSearchName":"class.title@text||$.name","ruleSearchAuthor":"","ruleSearchNoteUrl":"a@href||$.info_url","ruleSearchCoverUrl":"class.img@src||$.cover","ruleSearchKind":"","ruleSearchLastChapter":"class.chapter@text||$.lastchapter","ruleBookName":"","ruleBookAuthor":"class.name@class.author@text","ruleBookKind":"class.type@text","ruleBookLastChapter":"","ruleIntroduce":"id.js_desc_content@text","ruleCoverUrl":"class.thumbnail@tag.img@src","ruleChapterList":"id.js_chapters@li","ruleChapterName":"a@text","ruleChapterUrl":"","ruleContentUrl":"a@href","ruleBookContent":"class.item@tag.img@data-src@Header:{Referer:\"http://zcymh.com/\"}"};
