...
class ConvertedSource_source_65_8717b6 extends ComicSource {
  name = "龙王传说网";
  key = "source_65_8717b6";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://lw.131453.xyz";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:34.0) Gecko/20100101 Firefox/34.0", "Referer": "https://lw.131453.xyz"};
  legadoRules = {"ruleSearchUrl":"https://lw.131453.xyz/manhua/","ruleSearchList":"tag.tr!0","ruleSearchName":"tag.td.0@text#漫画","ruleSearchAuthor":"tag.td.1@text","ruleSearchNoteUrl":"tag.a@href","ruleSearchCoverUrl":"","ruleSearchKind":"","ruleSearchLastChapter":"tag.td.2@text","ruleBookName":"tag.h1@text#漫画","ruleBookAuthor":"class.m-infos@tag.span.0@text#作者：","ruleBookKind":"class.m-infos@tag.span.1@text#状态：","ruleBookLastChapter":"class.m-upd@tag.a@text","ruleIntroduce":"tag.p.0@text","ruleCoverUrl":"tag.img.0@src","ruleChapterList":":_H006_/Of+/2Nqv2RZhvg5hNqjRS2PFBZaJ1ST34iFvoeybUs=\n","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"tag.a@href","ruleBookContent":":_H006_\nutJC4UwxH05DoUeO\n"};
