...
class ConvertedSource_source_41_b0c446 extends ComicSource {
  name = "动漫屋";
  key = "source_41_b0c446";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://m.dm5.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0", "Referer": "https://m.dm5.com"};
  legadoRules = {"ruleSearchUrl":"https://m.dm5.com/pagerdata.ashx?d={{String(new Date()).replace('(GMT+08:00)','(China Standard Time)')}}@t=7&pageindex=searchPage&f=0&title=searchKey@Header:{Referer:host}","ruleSearchList":"$.*[?(@.Title)]","ruleSearchName":"$.Title","ruleSearchAuthor":"$.Author","ruleSearchNoteUrl":"$.UrlKey||$.Url@js:\"http://m.dm5.com/\"+result.replace(/\\//g,\"\")+\"/\"","ruleSearchCoverUrl":"$.ShowPicUrlB||$.BigPic@Header:{Referer:host}","ruleSearchKind":"$.TagList&&$.Status@js:result.join().replace(\"0\",\"连载中\").replace(\"1\",\"已完结\")","ruleSearchLastChapter":"$.ShowLastPartName||$.LastPartShowName","ruleBookName":"class.detail-main-info-title@text@put:{name:\"class.detail-main-info-title@text@js:encodeURI(result)\"}","ruleBookAuthor":"class.detail-main-info-author@tag.a@text#作者：","ruleBookKind":"class.detail-main-info-class@tag.span@text&&class.detail-list-title-1@text","ruleBookLastChapter":"class.detail-list-title-2@text@js:result.replace(decodeURI(\"@get:name\"),\"\").trim()","ruleIntroduce":"class.detail-desc@text","ruleCoverUrl":"class.detail-main-cover@tag.img@src@Header:{Referer:thisPage}","ruleChapterList":":_H006_\nFpnLS2rBYntrLhwLtBbjn2YnKWoLODXUEx7t\n","ruleChapterName":"text@js:result.replace(decodeURI(\"@get:{name}\"),\"\")","ruleChapterUrl":"","ruleContentUrl":"href","ruleBookContent":":_H006_f5lSueYUvp0wlUBKpeRomMyT6YQeBBCAayFPeG1bC8LaYU2myAqA7z33/wBbBTYWmuRUFm912/+u\n+xAAnOHy4q2QkYWeTpp2kiwNPwgKeVbXG7eyyp7mw8qpEVYnlYAI\n"};
