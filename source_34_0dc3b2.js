...
class ConvertedSource_source_34_0dc3b2 extends ComicSource {
  name = "特漫网";
  key = "source_34_0dc3b2";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.44te.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:34.0) Gecko/20100101 Firefox/34.0", "Referer": "https://www.44te.com"};
  legadoRules = {"ruleSearchUrl":"https://www.44te.com/search?keyword=searchKey","ruleSearchList":"class.mh-item","ruleSearchName":"tag.h2@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"tag.a.0@href","ruleSearchCoverUrl":"class.mh-cover@style@js:result.match(/\\((.*?)\\)/)[1]@Header:{Referer:thisPage}","ruleSearchKind":"","ruleSearchLastChapter":"class.chapter@tag.a@text","ruleBookName":"class.info@tag.h1@text","ruleBookAuthor":"class.subtitle@text#作者：","ruleBookKind":"class.tip.1@tag.a@text","ruleBookLastChapter":"id.detail-list-select@tag.li.-1@text","ruleIntroduce":"class.content@text","ruleCoverUrl":"class.cover@tag.img@src","ruleChapterList":":_H006_yXvUcvAsz/I1j9ovww2Pn4R6ed/IWUBJO7JZQFDeBdg=\n","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href","ruleBookContent":":_H006_Bw5JPdQcciQSX82J1h+sfkhmxw4AdTBkQsA67o/v6b4HEUyp7b7mL9HYxkj2L4aKdXE43v5ytz71\nMac7tdzTXw==\n"};
