...
class ConvertedSource_source_44_fed97a extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "https://www.k886.net"
  };

  legadoRules = {
  "ruleSearchUrl": "https://www.k886.net/search-index?searchType=1&q=searchKey&page=searchPage",
  "ruleSearchList": "class.indliemh@tag.li",
  "ruleSearchName": "class.tit@text",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": "tag.a@href",
  "ruleSearchCoverUrl": "tag.img@src#img\\.k886#www\\.k886",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "tag.em@text#.*?\\s",
  "ruleBookName": "class.mh-detail@tag.dt@tag.a@title",
  "ruleBookAuthor": "class.mh-detail@tag.dd@tag.p.0@tag.a@text",
  "ruleBookKind": "class.mh-detail@tag.dd@tag.p.2@tag.a@text&class.mh-detail@tag.dd@tag.p.1@tag.a@text",
  "ruleBookLastChapter": "class.mh-detail@tag.dt@tag.em@text",
  "ruleIntroduce": "class.mh-introduce@tag.p.1@text",
  "ruleCoverUrl": "",
  "ruleChapterList": ":_H006_tlEGHXw42ARv7DT1Pa4dDsBvR2ZooaC2DMCLtjVRfaM=\n",
  "ruleChapterName": "tag.a@text#.*?\\s",
  "ruleChapterUrl": "",
  "ruleContentUrl": "tag.a@href",
  "ruleBookContent": ":_H006_xZZNyvvOYqGsb5n3ILJ/9mZekV7ZALQOvm7mVOdyp3YWqJsWp4V11YtSg0BARr78\n"
};
