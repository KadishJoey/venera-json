...
class ConvertedSource_source_36_d33fb7 extends ComicSource {
  ...
  legadoRules = {
  "ruleSearchUrl": "https://www.dongmanmanhua.cn/search?keyword=searchKey",
  ...
  "ruleSearchCoverUrl": "tag.img@src@Header:{Referer:host}",
  "ruleSearchKind": "class.genre@text",
  "ruleSearchLastChapter": "",
  "ruleBookName": "class.detail_header@class.subj@text",
  "ruleBookAuthor": "class.detail_header@class.author@text#作家信息",
  "ruleBookKind": "class.detail_header@class.genre@text",
  "ruleBookLastChapter": "",
  "ruleIntroduce": "class.detail_body@class.summary@text",
  "ruleCoverUrl": "class.detail_body@style@js:result.match(/url\\((.*?)\\)/)[1]@Header:{Referer:host}",
  "ruleChapterList": ":_H006_\n1U+q\n",
  "ruleChapterName": "text",
  "ruleChapterUrl": "",
  "ruleContentUrl": "url",
  "ruleBookContent": ":_H006_Bmrz4M96uMzpDRCxMFt0yIxDWtkIkjHmuD6/TDa3d47+ta26YusfQBNRBI2H0p9uBfZMzWdXk9fI\nXqmOwqPLpg==\n"
};
