...
class ConvertedSource_source_17_b7ddde extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "https://tk.myhl03.sbs"
  };

  legadoRules = {
  "ruleSearchUrl": "https://tk.myhl03.sbs/?s=searchKey&post_type=post",
  "ruleSearchList": "div.post",
  "ruleSearchName": ".con h3 a@text",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": ".img a@href",
  "ruleSearchCoverUrl": "img.thumb@src|img.thumb@data-src",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "",
  "ruleBookName": "h1@text",
  "ruleBookAuthor": "",
  "ruleBookKind": ".article-tags-top a@text",
  "ruleBookLastChapter": "",
  "ruleIntroduce": "",
  "ruleCoverUrl": ".article-content .gallery-item a@href",
  "ruleChapterList": "@js:[baseUrl]",
  "ruleChapterName": "@js:'查看全文'",
  "ruleChapterUrl": "",
  "ruleContentUrl": "@js:result",
  "ruleBookContent": ".article-content .gallery-item a@href"
};
