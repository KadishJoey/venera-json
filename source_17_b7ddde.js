...
class ConvertedSource_source_17_b7ddde extends ComicSource {
  name = "魅影画廊";
  key = "source_17_b7ddde";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://tk.myhl03.sbs";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36", "Referer": "https://tk.myhl03.sbs"};
  legadoRules = {"ruleSearchUrl":"https://tk.myhl03.sbs/?s=searchKey&post_type=post","ruleSearchList":"div.post","ruleSearchName":".con h3 a@text","ruleSearchAuthor":"","ruleSearchNoteUrl":".img a@href","ruleSearchCoverUrl":"img.thumb@src|img.thumb@data-src","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":"h1@text","ruleBookAuthor":"","ruleBookKind":".article-tags-top a@text","ruleBookLastChapter":"","ruleIntroduce":"","ruleCoverUrl":".article-content .gallery-item a@href","ruleChapterList":"@js:[baseUrl]","ruleChapterName":"@js:'查看全文'","ruleChapterUrl":"","ruleContentUrl":"@js:result","ruleBookContent":".article-content .gallery-item a@href"};
