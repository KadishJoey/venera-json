...
class ConvertedSource_source_58_9bd332 extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "https://www.gaonaojin.com"
  };

  legadoRules = {
  "ruleSearchUrl": "https://www.gaonaojin.com/index/index/search.html?keyboard=searchKey",
  "ruleSearchList": ".mh-list@li",
  "ruleSearchName": "h2@text",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": "a@href",
  "ruleSearchCoverUrl": "img@src|.mh-cover@data-original",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "p@a@text",
  "ruleBookName": "h1@text",
  "ruleBookAuthor": ".subtitle@a@text",
  "ruleBookKind": ".ticai@a@text",
  "ruleBookLastChapter": "",
