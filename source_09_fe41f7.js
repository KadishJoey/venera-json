...
class ConvertedSource_source_09_fe41f7 extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "https://www.dingmanhua.com"
  };

  legadoRules = {
  "ruleSearchUrl": "https://www.dingmanhua.com/search/?query=searchKey&page=searchPage",
  "ruleSearchList": "//div[@class=\" card-content\"]",
  ...
  "ruleBookName": "",
  "ruleBookAuthor": "//div[@class=\"author\"][1]/text()",
  "ruleBookKind": "//div[@class=\"status\"]/text()&&//div[@class=\"author\"][2]//a/text()",
  "ruleBookLastChapter": "//div[@class=\"author\"][3]/a/text()",
  "ruleIntroduce": "//p[@class=\"description\"][1]/text()",
  "ruleCoverUrl": "",
  "ruleChapterList": "$.data.chapters.*",
  "ruleChapterName": "*@js:(function(result){return result.split(\"\\n\")[2];})(result);",
  "ruleChapterUrl": "thisPage@js:(function(baseUrl){var url = baseUrl.replace(\".html\",\"\") + \"@form=form\";return url;})(baseUrl);",
  "ruleContentUrl": "*@js:(function(result){var sp = result.split(\"\\n\"); var contentIdStr = new String(sp[1]); var idStr = new String(sp[0]); return \"https://www.dingmanhua.com/chapter/\" + contentIdStr + \"-\" + idStr + \".html\";})(result);",
  "ruleBookContent": "//img//@data-src"
};
