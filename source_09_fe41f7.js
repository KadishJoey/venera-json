...
class ConvertedSource_source_09_fe41f7 extends ComicSource {
  name = "顶漫画";
  key = "source_09_fe41f7";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.dingmanhua.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0", "Referer": "https://www.dingmanhua.com"};
  legadoRules = {"ruleSearchUrl":"https://www.dingmanhua.com/search/?query=searchKey&page=searchPage","ruleSearchList":"//div[@class=\" card-content\"]","ruleSearchName":"//h3/text()","ruleSearchAuthor":"","ruleSearchNoteUrl":"//a/@href","ruleSearchCoverUrl":"//img/@data-src","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":"","ruleBookAuthor":"//div[@class=\"author\"][1]/text()","ruleBookKind":"//div[@class=\"status\"]/text()&&//div[@class=\"author\"][2]//a/text()","ruleBookLastChapter":"//div[@class=\"author\"][3]/a/text()","ruleIntroduce":"//p[@class=\"description\"][1]/text()","ruleCoverUrl":"","ruleChapterList":"$.data.chapters.*","ruleChapterName":"*@js:(function(result){return result.split(\"\\n\")[2];})(result);","ruleChapterUrl":"thisPage@js:(function(baseUrl){var url = baseUrl.replace(\".html\",\"\") + \"@form=form\";return url;})(baseUrl);","ruleContentUrl":"*@js:(function(result){var sp = result.split(\"\\n\"); var contentIdStr = new String(sp[1]); var idStr = new String(sp[0]); return \"https://www.dingmanhua.com/chapter/\" + contentIdStr + \"-\" + idStr + \".html\";})(result);","ruleBookContent":"//img//@data-src"};
