...
class ConvertedSource_cosplaytele_25_190983 extends ComicSource {
  ...
  legadoRules = {
  "ruleSearchUrl": "https://cosplaytele.com/?s=searchKey&paged=searchPage",
  "ruleSearchList": "div.col.post-item",
  "ruleSearchName": ".post-title a@text@js:/video/i.test(result) ? '' : result",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": ".post-title a@href",
  "ruleSearchCoverUrl": ".box-image img@src",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "",
  "ruleBookName": "h1@text",
  "ruleBookAuthor": "",
  "ruleBookKind": "body[class]@class@js:result.indexOf('single-format-image')>=0 ? 'image' : (result.indexOf('single-format-video')>=0 ? 'video' : '')",
  "ruleBookLastChapter": "",
  "ruleIntroduce": ".entry-content blockquote@text",
  "ruleCoverUrl": ".entry-content div.gallery img@src",
  "ruleChapterList": "h1",
  "ruleChapterName": "@js:'1'",
  "ruleChapterUrl": "",
  "ruleContentUrl": "@js:baseUrl",
  "ruleBookContent": ".entry-content div.gallery img@src"
};
