...
class ConvertedSource_cosplaytele_25_190983 extends ComicSource {
  name = "CosplayTele";
  key = "cosplaytele_25_190983";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://cosplaytele.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36", "Referer": "https://cosplaytele.com"};
  legadoRules = {"ruleSearchUrl":"https://cosplaytele.com/?s=searchKey&paged=searchPage","ruleSearchList":"div.col.post-item","ruleSearchName":".post-title a@text@js:/video/i.test(result) ? '' : result","ruleSearchAuthor":"","ruleSearchNoteUrl":".post-title a@href","ruleSearchCoverUrl":".box-image img@src","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":"h1@text","ruleBookAuthor":"","ruleBookKind":"body[class]@class@js:result.indexOf('single-format-image')>=0 ? 'image' : (result.indexOf('single-format-video')>=0 ? 'video' : '')","ruleBookLastChapter":"","ruleIntroduce":".entry-content blockquote@text","ruleCoverUrl":".entry-content div.gallery img@src","ruleChapterList":"h1","ruleChapterName":"@js:'1'","ruleChapterUrl":"","ruleContentUrl":"@js:baseUrl","ruleBookContent":".entry-content div.gallery img@src"};
