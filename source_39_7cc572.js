...
class ConvertedSource_source_39_7cc572 extends ComicSource {
  ...
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:34.0) Gecko/20100101 Firefox/34.0", "Referer": "http://www.1kkk.com"};
  legadoRules = {"ruleSearchUrl":"http://www.1kkk.com/search?title=searchKey&language=1&page=searchPage","ruleSearchList":"class.banner_detail_form&class.mh-list@tag.li","ruleSearchName":"class.title.0@tag.a@text","ruleSearchAuthor":"class.subtitle@tag.a@text|class.author.0@tag.a@text","ruleSearchNoteUrl":"class.title@tag.a@href#(\\/.*\\/)#http://m.1kkk.com$1","ruleSearchCoverUrl":"tag.img@src|class.mh-cover@style#.*\\(([^\\)]+)\\)#$1","ruleSearchKind":"","ruleSearchLastChapter":"class.chapter.0@tag.a@text","ruleBookName":"class.detail-main-info-title.0@text","ruleBookAuthor":"class.detail-main-info-author@tag.a@text","ruleBookKind":"class.detail-main-info-class@tag.a@text","ruleBookLastChapter":"","ruleIntroduce":"class.detail-desc@text","ruleCoverUrl":"class.detail-main-cover@tag.img@src","ruleChapterList":":_H006_5bCVPp2ep0iQbR3h1AtyXo+wNl2uEUbSNhUM6pVesfUgHvLUfJkqKYxx5zRgHlr0\n","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href","ruleBookContent":":_H006_\n"};
