...
class ConvertedSource_gmanhua_59_ee9658 extends ComicSource {
  ...
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:34.0) Gecko/20100101 Firefox/34.0", "Referer": "http://www.gmanhua.com"};
  legadoRules = {"ruleSearchUrl":"http://www.gmanhua.com/search?title=searchKey&page=searchPage&language=1","ruleSearchList":"class.ssnrk|class.topbg|class.cl4@tag.li","ruleSearchName":"tag.a.0@text#1-.*$","ruleSearchAuthor":"class.huih.0@tag.a@text","ruleSearchNoteUrl":"tag.a.0@href","ruleSearchCoverUrl":"tag.img@src","ruleSearchKind":"","ruleSearchLastChapter":"class.matoa@tag.a.0@text|tag.a.1@text#\\[|\\]","ruleBookName":"class.csly1z@tag.a.0@text@put:{name:\"class.csly1z@tag.a.0@text@js:encodeURI(result)\"}","ruleBookAuthor":"class.csly1z@html@js:org.jsoup.Jsoup.parse(result.split(\"地区：\")[1]).select(\"a:gt(0)\").toArray().map(a=>a.text()).join()","ruleBookKind":"class.csly1z@text@js:result.join().replace(/^.*状态：(.*?)\\s*地区.*$/,\"$1\").replace(/类型：\\s*/,\"\").split(/\\s/)","ruleBookLastChapter":"class.nr7@tag.a.0@text@js:result.replace(decodeURI(\"@get:{name}\"),\"\")","ruleIntroduce":"class.cs1y3@text#^.*?简介：","ruleCoverUrl":"class.cs1z@tag.img@src","ruleChapterList":":_H006_vkesU/g0oqfvdnpaRpVddbh9j/9X/gqWUptbKZSh5qE=\n","ruleChapterName":"tag.a@text","ruleChapterUrl":"","ruleContentUrl":"tag.a@href","ruleBookContent":":_H006_\n"};
