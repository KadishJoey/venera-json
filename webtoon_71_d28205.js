...
class ConvertedSource_webtoon_71_d28205 extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "https://us-m.webtoons.com"
  };

  legadoRules = {
  "ruleSearchUrl": "https://us-m.webtoons.com/zh-hant/search/result?keyword=searchKey&searchType=ALL&start=searchPage@Header:{Cookie: \"locale=zh_TW;\", Referer: \"https://us-m.webtoons.com/zh-hant/search/\"}",
  "ruleSearchList": "$..titleList@js:var list = [];\nresult.map(a=>a.map(b=>list.push(b)));\nlist",
  "ruleSearchName": "$.title",
  "ruleSearchAuthor": "$.titleAuthorList..authorName || $.writingAuthorName",
  "ruleSearchNoteUrl": "@js: var type = result.webtoonType;\r\nvar url = \"\";\r\nif (type == \"CHALLENGE\") {\r\n    url = \"https://m.webtoons.com/zh-hant/challenge/\" + result.title + \"/list?title_no=\" + result.titleNo;\r\n} else {\r\n    url = \"https://us-m.webtoons.com/zh-hant/\" + result.representGenre + \"/\" + result.titleGroupName + \"/list?title_no=\" + result.titleNo;\r\n}\r\nurl",
  "ruleSearchCoverUrl": "https://mwebtoon-phinf.pstatic.net{$.thumbnailIpad}?type=q70@Header:{Cookie: \"locale=zh_TW;\", Referer: \"https://us-m.webtoons.com/zh-hant/search/\"}",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "",
  "ruleBookName": "@css:.subj@text@js:result.split(\"\\n\")[0]",
  "ruleBookAuthor": "@css:.author:first-child@text",
  "ruleBookKind": "@css:.genre@text",
  "ruleBookLastChapter": "@css:#_episodeList li:first-of-type p:first-of-type span@text",
  "ruleIntroduce": "@css:p.summary > span@text",
  "ruleCoverUrl": "@js:\r\n//java.toast(result)\r\nvar doc = org.jsoup.Jsoup.parse(result);\r\nvar string1 = doc.select(\"meta[property='og:image']\").toArray()[0].attr(\"content\");\r\nvar url = \"\";\r\nif (null != string1) {\r\n    url = string1;\n    if(url.match(/.jpg$/)) {\n        url = url + \"?type=q70\";\n    }\r\n} else {\r\n    url = doc.select(\".detail_chal_pic img\").toArray()[0].attr(\"src\").replace(\"type=f204_204\", \"type=q70\");\r\n}\r\nurl\r\n@Header:{\"Cookie\":\"locale=zh_TW;\",Referer:host}",
  "ruleChapterList": ":_H006_kY7lXEpkRWXGrGuDYvD5V/9BMDX4WUiHIIoZeyH6uAY=\n",
  "ruleChapterName": "@css:.sub_title@text",
  "ruleChapterUrl": "",
  "ruleContentUrl": "@css:a@href",
  "ruleBookContent": ":_H006_ttCu9Y/+zr3or//9ccjm/+aNcT+JA2o9rEVZ2q4biLM5xGQr+C1mLVwEAWS14tL9RZtr28t/KPRZ\nJ2/PMjO/k2bPwLBwhOKgRH/IySRM2F/H9vaJY0urrvlxsQVY4pAGPxn7GVjB7aSWLCd4lTKhuQYp\nYUFE3gcZAI7YHXtjmA4t31k0KL9H4MLJh5XPgEvY0EpIhVTgioXpioQTJKVJYQ==\n"
};
