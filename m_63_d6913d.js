...
class ConvertedSource_m_63_d6913d extends ComicSource {
  name = "神漫画-M";
  key = "m_63_d6913d";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  ...
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Android Mobile)", "Referer": "https://m.taomanhua.com"};
  legadoRules = {"ruleSearchUrl":"https://m.taomanhua.com/api/getsortlist/?search_type=&search_key=searchKey&page=searchPage&size=30&productname=smh&platformname=wap","ruleSearchList":"$.data.update[*].info[*]||$.data.data[*]||$.data[*]","ruleSearchName":"$.comic_name","ruleSearchAuthor":"$.comic_author","ruleSearchNoteUrl":"https://m.taomanhua.com/api/getcomicinfo_body/?comic_id={$.comic_id}&productname=smh&platformname=wap","ruleSearchCoverUrl":"http://image.mhxk.com/mh/{$.comic_id}.jpg-600x800.webp","ruleSearchKind":"$.comic_type||$.sort_typelist@js:result.join().match(/[^(\\w+),\\|]+/g)","ruleSearchLastChapter":"$.last_chapter_name||$.comic_chapter_name","ruleBookName":"$.data.comic_name@put:{comic_id:$.data.comic_id}","ruleBookAuthor":"$.data.comic_author","ruleBookKind":"$.data.comic_type_new[*].name","ruleBookLastChapter":"$.data.last_chaptet_name","ruleIntroduce":"$.data.comic_desc","ruleCoverUrl":"$.data.cover_list[0]","ruleChapterList":":_H006_wcOShjk/cQXPM6VRdy8lvqBeDPnaQSQVycOrEYktOno=\n","ruleChapterName":"$.chapter_name@put:{chapter_id:$.chapter_id}","ruleChapterUrl":"","ruleContentUrl":"https://m.taomanhua.com/api/getchapterinfov2?product_id=3&productname=smh&platformname=wap&comic_id=@get:{comic_id}&chapter_newid={$.chapter_id}&isWebp=1&quality=high","ruleBookContent":":_H006_bIXsFqy/y7R4uDMbwzbY5W4f/wFH2qJE6fc7jtaaJHvIR3FJ60NoH9pJ+f62Hc9OjboW+46Ps7yw\nl794X4LgWTs9XEvACqT22QPfOnrqKZ0=\n"};
