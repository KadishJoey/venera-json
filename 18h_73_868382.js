...
class ConvertedSource_18h_73_868382 extends ComicSource {
  name = "◯ 18H";
  key = "18h_73_868382";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://18h.mm-cg.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36", "Referer": "https://18h.mm-cg.com"};
  legadoRules = {"ruleSearchUrl":"https://18h.mm-cg.com/zh/18H_search/all/searchKey/searchPage.html","ruleSearchList":".post","ruleSearchName":"tag.a.1@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"a@href","ruleSearchCoverUrl":"img@src","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":"","ruleBookAuthor":"","ruleBookKind":".changetextval@text","ruleBookLastChapter":"","ruleIntroduce":".archive-title!-1@tag.h1@text","ruleCoverUrl":"","ruleChapterList":"@js:\nlist = [{\"text\": \"1\", \"href\": baseUrl}];","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href","ruleBookContent":"@js:\nimg = [];\n\np = /Large\\_cgurl\\[(\\d+)\\]\\s=\\s\".*?\"/g;\na = String(result).match(p);\nfor(i = 0; i < a.length; i++)\n{\n    img.push(a[i].match(/\"(.*?)\"/)[1]);\n}\n\nimg@Header:{Referer:host}"};
