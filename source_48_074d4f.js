...
class ConvertedSource_source_48_074d4f extends ComicSource {
  name = "漫画皮";
  key = "source_48_074d4f";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.manhuapi.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Android 9; Mobile; rv:68.0) Gecko/68.0 Firefox/68.0", "Referer": "https://www.manhuapi.com"};
  legadoRules = {"ruleSearchUrl":"https://www.manhuapi.com/e/search/?keyboard=searchKey&classid=0&searchget=1&show=title,author","ruleSearchList":"id.sitembox@tag.dl","ruleSearchName":"tag.h3@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"tag.a@href","ruleSearchCoverUrl":"tag.img@src","ruleSearchKind":"","ruleSearchLastChapter":"class.book_other.1@tag.a@text","ruleBookName":"","ruleBookAuthor":"class.cy_xinxi.0@tag.a@text","ruleBookKind":"class.cy_xinxi.1@tag.a@text","ruleBookLastChapter":"","ruleIntroduce":"id.comic-description@text","ruleCoverUrl":"","ruleChapterList":":_H006_ETL5JZvcc4bTJkHgl5iM9gniJYd6FXbnQnTjxVi5jCY=\n","ruleChapterName":"text","ruleChapterUrl":"class.cy_zhangjie_top@tag.a.1@href","ruleContentUrl":"tag.a@href","ruleBookContent":":_H006_6NXsLZs0TI105JGJBTasNO6YvVfdCCWY/SE9N7SNunk=\n"};
