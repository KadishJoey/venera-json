...
class ConvertedSource_source_21_a16969 extends ComicSource {
  name = "鸟鸟韩漫·直连";
  key = "source_21_a16969";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://nnhm95.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36", "Referer": "https://nnhm95.com"};
  legadoRules = {"ruleSearchUrl":"https://nnhm95.com/catalog.php?key=searchKey&page=searchPage","ruleSearchList":"ul.col_3_1 li","ruleSearchName":"a.txtA@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"a.ImgA@href","ruleSearchCoverUrl":"a.ImgA img@src","ruleSearchKind":"","ruleSearchLastChapter":".info a@text","ruleBookName":"[id=Cover] img@title","ruleBookAuthor":"p.txtItme@text@js:result.split(String.fromCharCode(10))[0]","ruleBookKind":"p.txtItme a@text","ruleBookLastChapter":"","ruleIntroduce":"p.txtDesc@text@js:result.replace(/^介绍:/,'')","ruleCoverUrl":"[id=Cover] img@src","ruleChapterList":"-ul[id=mh-chapter-list-ol-0] a","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href@js:'https://nnhm95.com'+result","ruleBookContent":".img-wrap img@data-src"};
