...
class ConvertedSource_source_21_a16969 extends ComicSource {
  ...
  headers = {
    ...
    "Referer": "https://nnhm95.com"
  };

  legadoRules = {
  "ruleSearchUrl": "https://nnhm95.com/catalog.php?key=searchKey&page=searchPage",
  "ruleSearchList": "ul.col_3_1 li",
  "ruleSearchName": "a.txtA@text",
  "ruleSearchAuthor": "",
  "ruleSearchNoteUrl": "a.ImgA@href",
  "ruleSearchCoverUrl": "a.ImgA img@src",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": ".info a@text",
  "ruleBookName": "[id=Cover] img@title",
  "ruleBookAuthor": "p.txtItme@text@js:result.split(String.fromCharCode(10))[0]",
  "ruleBookKind": "p.txtItme a@text",
  "ruleBookLastChapter": "",
  "ruleIntroduce": "p.txtDesc@text@js:result.replace(/^介绍:/,'')",
  "ruleCoverUrl": "[id=Cover] img@src",
  "ruleChapterList": "-ul[id=mh-chapter-list-ol-0] a",
  "ruleChapterName": "text",
  "ruleChapterUrl": "",
  "ruleContentUrl": "href@js:'https://nnhm95.com'+result",
  "ruleBookContent": ".img-wrap img@data-src"
};
