...
class ConvertedSource_source_22_2764a4 extends ComicSource {
  name = "武芊漫画·直连";
  key = "source_22_2764a4";
  version = "0.2.0";
  minAppVersion = "1.0.0";
  url = "";
  ...
  headers = {
    ...
    "Referer": "https://comic.mkzcdn.com"
  };

  legadoRules = {
  "ruleSearchUrl": "https://comic.mkzcdn.com/search/keyword/?keyword=searchKey&page_num=searchPage&page_size=20",
  "ruleSearchList": "@JSon:$..list[*]",
  "ruleSearchName": "@JSon:$.title@put:{comic_id:{{result.comic_id}}}",
  "ruleSearchAuthor": "@JSon:$.author_title",
  "ruleSearchNoteUrl": "@js:'https://comic.mkzcdn.com/comic/info/?comic_id='+result.comic_id",
  "ruleSearchCoverUrl": "@JSon:$.cover",
  "ruleSearchKind": "",
  "ruleSearchLastChapter": "@JSon:$.chapter_title",
  "ruleBookName": "@JSon:$.data.title",
  "ruleBookAuthor": "@JSon:$.data.author_title",
  "ruleBookKind": "",
  "ruleBookLastChapter": "",
  "ruleIntroduce": "@JSon:$.data.content",
  "ruleCoverUrl": "@JSon:$.data.cover",
  "ruleChapterList": "@JSon:$.data",
  "ruleChapterName": "@JSon:$.title",
  "ruleChapterUrl": "@js:var d=JSON.parse(result);java.put('comic_id', d.data.comic_id);'https://comic.mkzcdn.com/chapter/v1/?comic_id='+d.data.comic_id",
  "ruleContentUrl": "@js:'https://comic.mkzcdn.com/chapter/content/?chapter_id='+result.chapter_id+'&comic_id=@get:{comic_id}'",
  "ruleBookContent": "@JSon:$.data[*].image"
};
