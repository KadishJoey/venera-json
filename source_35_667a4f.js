...
class ConvertedSource_source_35_667a4f extends ComicSource {
  name = "漫画人";
  key = "source_35_667a4f";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "http://www.manhuaren.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0", "Referer": "http://www.manhuaren.com"};
  legadoRules = {"ruleSearchUrl":"http://www.manhuaren.com/pagerdata.ashx?d={{String(new Date()).replace(\"(GMT+08:00)\",\"(China Standard Time)\")}}@t=7&pageindex=searchPage&f=0&title=searchKey@Header:{Referer:host}","ruleSearchList":"$.*[?(@.Title)]","ruleSearchName":"$.Title","ruleSearchAuthor":"$.Author","ruleSearchNoteUrl":"$.UrlKey||$.Url@js:\"http://www.manhuaren.com/\"+result.replace(/\\//g,\"\")+\"/\"","ruleSearchCoverUrl":"$.ShowPicUrlB||$.BigPic","ruleSearchKind":"$.TagList&&$.Status@js:result.join().replace(\"0\",\"连载中\").replace(\"1\",\"已完结\")","ruleSearchLastChapter":"$.ShowLastPartName||$.LastPartShowName","ruleBookName":"class.detail-main-info-title@text@put:{name:\"class.detail-main-info-title@text@js:encodeURI(result)\"}","ruleBookAuthor":"class.detail-main-info-author@tag.a@text","ruleBookKind":"class.detail-main-info-class@tag.span@text&class.detail-list-title-1@text","ruleBookLastChapter":"class.detail-list-title-2@text@js:result.replace(decodeURI(\"@get:{name}\"),\"\")","ruleIntroduce":"class.detail-desc@text","ruleCoverUrl":"class.detail-main-cover@tag.img@src","ruleChapterList":":_H006_pcaDTL12ON/cGv4SRE922KK/U+L4oj2S/ipkAxQLTLXlWLrNIEGo56iqgpIekhcT\n","ruleChapterName":"tag.a@text@js:result.replace(decodeURI(\"@get:{name}\"),\"\")","ruleChapterUrl":"","ruleContentUrl":"tag.a@href","ruleBookContent":":_H006_NSPsBKZS0OOchw66WktD6Wg9iDGnWl1iwQLNgfguAgdJoTo97NHYOa2xS7IT/Pa9JaE+x/iG41K7\n5DwEpI+/L8EaSwBbHnUmHV9dSWd7tgdhr7ucJjL+MHAIif5NMOtA\n"};
