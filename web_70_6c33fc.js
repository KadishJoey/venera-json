...
class ConvertedSource_web_70_6c33fc extends ComicSource {
  name = "◯ 包子漫画web";
  key = "web_70_6c33fc";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  ...
  defaultHeaders = {"User-Agent": "baozimh_android/1.0.30/gb/adset", "Referer": "https://cn.baozimhcn.com"};
  legadoRules = {"ruleSearchUrl":"https://cn.bzmanga.com/search?q=searchKey","ruleSearchList":".comics-card","ruleSearchName":"h3@text","ruleSearchAuthor":"small@text","ruleSearchNoteUrl":"a@href","ruleSearchCoverUrl":"amp-img[noloading^=\"\"]@src@Header:{Referer:host}","ruleSearchKind":"span@text","ruleSearchLastChapter":".tags@text|.tab@text","ruleBookName":"","ruleBookAuthor":".comics-detail__author@text","ruleBookKind":".tag-list@span@text","ruleBookLastChapter":"","ruleIntroduce":".comics-detail__desc@html","ruleCoverUrl":"","ruleChapterList":"-.l-box@.pure-g!0@.comics-chapters||.pure-g@.comics-chapters","ruleChapterName":"a@text\n@js:\na = \" \" + result","ruleChapterUrl":"","ruleContentUrl":"a@href","ruleBookContent":"amp-img@data-src"};
