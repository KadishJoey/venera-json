...
// Source: 鳥鳥韓漫nnhanman5
// NOTE: This is a best-effort compatibility conversion. Complex Legado JS rules may require manual fixes.

class ConvertedSource_nnhanman5_10_f0cebd extends ComicSource {
  name = "鳥鳥韓漫nnhanman5";
  key = "nnhanman5_10_f0cebd";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://nnhanman5.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36", "Referer": "https://nnhanman5.com"};
  legadoRules = {"ruleSearchUrl":"https://nnhanman5.com/catalog.php?key=searchKey&page=searchPage","ruleSearchList":"ul.col_3_1 li","ruleSearchName":"a.txtA@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"a.ImgA@href","ruleSearchCoverUrl":"a.ImgA img@src","ruleSearchKind":"","ruleSearchLastChapter":".info a@text","ruleBookName":"h1@text","ruleBookAuthor":"","ruleBookKind":"p.txtItme a@text","ruleBookLastChapter":"","ruleIntroduce":"p.txtDesc@text@js:result.replace(/^介绍:/,'')","ruleCoverUrl":"[id=Cover] img@src","ruleChapterList":"-ul[id=mh-chapter-list-ol-0] a","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href@js:'https://nnhanman5.com'+result","ruleBookContent":".img-wrap img@data-src"};
