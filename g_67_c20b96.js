...
class ConvertedSource_g_67_c20b96 extends ComicSource {
  name = "G站漫画";
  key = "g_67_c20b96";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.godamanga.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36 Edg/116.0.1938.69", "Referer": "https://www.godamanga.com"};
  legadoRules = {"ruleSearchUrl":"https://go.mgsearcher.com/indexes/mangaStrapiPro/search@{\"q\":\"searchKey\",\"hitsPerPage\":30,\"page\":searchPage}@Header:{Authorization:\"Bearer 9bdaaa44f0dd520da24298a02818944327b8280a79feb480302feda7c009264a\"}","ruleSearchList":"class.grid-cols-3@class.pb-2||$.hits","ruleSearchName":"tag.h3@text||$.title","ruleSearchAuthor":"","ruleSearchNoteUrl":"tag.a@href||https://godamanga.com/manga/{$.slug}","ruleSearchCoverUrl":"tag.img@src||$.cover","ruleSearchKind":"","ruleSearchLastChapter":"$.updatedAt","ruleBookName":"tag.h1@text#[連載中|完結]","ruleBookAuthor":"class.py-1.0@text#作者：","ruleBookKind":"class.py-1.1@tag.a@text&&class.py-1.2@tag.a@text","ruleBookLastChapter":"class.gap-y-2.0@tag.a.0@tag.span.0@text","ruleIntroduce":"class.my-unit-md@text","ruleCoverUrl":"id.MangaCard@tag.img@src","ruleChapterList":":_H006_TMSEGeZb7mqUz0x2erwfmiOMD7TjOoxNiU+RDG7YT3w=\n","ruleChapterName":"tag.span.0@text","ruleChapterUrl":"@css:a[href~=chapterlist]@href","ruleContentUrl":"tag.a@href","ruleBookContent":":_H006_xiEfPSg3F2z6FRkPULWfeY8YH7hfjQpx+xWmJXSkSglJHtN6Xg4o6rGSjaLGXb9Q\n"};
