...
class ConvertedSource_source_03_c97d34 extends ComicSource {
  name = "污漫天堂🔞";
  key = "source_03_c97d34";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://wmtt5.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36", "Referer": "https://wmtt5.com"};
  legadoRules = {"ruleSearchUrl":"https://wmtt5.com/cata.php?key=searchKey","ruleSearchList":"class.module-item","ruleSearchName":"a@title","ruleSearchAuthor":"","ruleSearchNoteUrl":"a@href","ruleSearchCoverUrl":"img@data-original","ruleSearchKind":"","ruleSearchLastChapter":"","ruleBookName":"","ruleBookAuthor":"div.module-info-item-content@text","ruleBookKind":"div.module-info-tag-link@text","ruleBookLastChapter":"","ruleIntroduce":"div.module-info-introduction-content.show-desc@text","ruleCoverUrl":"div.module-item-cover@data-original","ruleChapterList":"a.module-play-list-link","ruleChapterName":"a@title","ruleChapterUrl":"","ruleContentUrl":"a@href","ruleBookContent":"img@data-src"};
