...
class ConvertedSource_a_43_e3f585 extends ComicSource {
  name = "新漫画-A";
  key = "a_43_e3f585";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  ...
  defaultHeaders = {"User-Agent": "okhttp/3.10.0", "Referer": "https://xapi.xinmanhua.net"};
  legadoRules = {"ruleSearchUrl":"https://xapi.xinmanhua.net/search/selfdefine@keyword=searchKey&page=searchPage","ruleSearchList":"@JSon:$.data.*","ruleSearchName":"@JSon:$.attributes.title","ruleSearchAuthor":"@JSon:$.attributes.author","ruleSearchNoteUrl":"https://xapi.xinmanhua.net/worksinfos/{$.attributes.wid}?include=chapters.digests","ruleSearchCoverUrl":"@JSon:$.attributes.logo_detail","ruleSearchKind":"@JSon:$.attributes.workscate","ruleSearchLastChapter":"@JSon:$.attributes.lastctitle","ruleBookName":"","ruleBookAuthor":"","ruleBookKind":"","ruleBookLastChapter":"","ruleIntroduce":"@JSon:$.data.attributes.intro&&$.data.attributes.description","ruleCoverUrl":"","ruleChapterList":":_H006_q18e+LNigXNr9XvRs4LuD8NPHHh3jiNZVfUtOtJiALs=\n","ruleChapterName":"@JSon:$.attributes.title&&$.attributes.intro","ruleChapterUrl":"","ruleContentUrl":"https://xapi.xinmanhua.net/chapters/{$.id}/qualitywebs","ruleBookContent":":_H006_r/n49zozVr5hzWEgcgiPopq/emTYNK4x0Qm8+024FdE=\n"};
