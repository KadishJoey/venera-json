...
class ConvertedSource_a_62_528fe9 extends ComicSource {
  name = "漫客栈-A";
  key = "a_62_528fe9";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  ...
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Linux; Android 12; Redmi K30 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.0.0 Mobile Safari/537.36 EdgA/110.0.1587.66", "Referer": "http://comic.mkzhan.com"};
  legadoRules = {"ruleSearchUrl":"https://comic.mkzhan.com/search/keyword/?keyword=searchKey&page_num=searchPage&page_size=20","ruleSearchList":"$.data.list.*","ruleSearchName":"$.title@put:{comic_id:$.comic_id}","ruleSearchAuthor":"$.author_title","ruleSearchNoteUrl":"https://comic.mkzhan.com/comic/info/?comic_id={$.comic_id}","ruleSearchCoverUrl":"$.cover@js:result.replace(/\\.(jpg|JPG).*/g,\".$1!cover-400\")","ruleSearchKind":"","ruleSearchLastChapter":"$.chapter_title","ruleBookName":"$.data.title","ruleBookAuthor":"","ruleBookKind":"","ruleBookLastChapter":"$.data.chapter_title","ruleIntroduce":"$.data.content","ruleCoverUrl":"","ruleChapterList":":_H006_pPR9EcmpFNpIwB9PBcf7eA==\n","ruleChapterName":"$.title","ruleChapterUrl":"https://comic.mkzhan.com/chapter/?comic_id={$.data.comic_id}","ruleContentUrl":"https://comic.mkzhan.com/chapter/content/v1/?chapter_id={$.chapter_id}&comic_id=@get:{comic_id}&format=1&quality=1&sign=0&type=1&uid=0","ruleBookContent":":_H006_I8gCeyrLSUWjBQBDaBeytOdj9l6Mf++kaD/zcJCZJqc=\n"};
