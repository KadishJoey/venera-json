...
class ConvertedSource_177_75_d9f4ef extends ComicSource {
  name = "◯ 177漫画";
  key = "177_75_d9f4ef";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  url = "";
  baseUrl = "https://www.177picyy.com";
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36", "Referer": "https://www.177picyy.com"};
  legadoRules = {"ruleSearchUrl":"https://www.177picyy.com/page/searchPage/?s=searchKey&cat=0","ruleSearchList":"id.main@.picture-box||id.main@article","ruleSearchName":"h2@text\n@js:\njava.put(\"h2\", result);","ruleSearchAuthor":"","ruleSearchNoteUrl":"a@href","ruleSearchCoverUrl":"img@src\n@js:\na = String(result);\np = a.replace(/w=(\\d+)/, \"w=810\");\np = p.replace(/h=(\\d+)/, \"h=1440\");\np;","ruleSearchKind":"tag.span.1@text","ruleSearchLastChapter":"","ruleBookName":"","ruleBookAuthor":"","ruleBookKind":"","ruleBookLastChapter":"","ruleIntroduce":"@js:\na = java.get(\"h2\");","ruleCoverUrl":"","ruleChapterList":"@js:\nu = /class=\"page-links\"[\\s\\S]*?<\\/div>/;\na = String(result).match(u)[0];\np = a.match(/href=\".*?\"/g);\nlist = [];\nlist.push({\"text\": 1, \"href\": baseUrl});\nfor(i = 1; i < p.length - 1; i++)\n{\n\t\tlist.push({\n\t\t\t\"text\": String(i + 1),\n\t\t\t\"href\": p[i].match(/\"(.*?)\"/)[1]\n   });\n}\nlist;","ruleChapterName":"text","ruleChapterUrl":"","ruleContentUrl":"href","ruleBookContent":".single-content@img@data-lazy-src@Header:{Referer:host}"};
