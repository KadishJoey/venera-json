...
class ConvertedSource_m_51_4e1530 extends ComicSource {
  name = "知音漫客-M";
  key = "m_51_4e1530";
  version = "0.1.0";
  minAppVersion = "1.0.0";
  ...
  defaultHeaders = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64)", "Referer": "https://m.zymk.cn"};
  legadoRules = {"ruleSearchUrl":"https://m.zymk.cn/sort/all.html?key=searchKey","ruleSearchList":"class.comic-sort@tag.li","ruleSearchName":"tag.h3@text","ruleSearchAuthor":"","ruleSearchNoteUrl":"tag.a.0@href","ruleSearchCoverUrl":"tag.img@data-src@Header:{Referer:host}","ruleSearchKind":"","ruleSearchLastChapter":"tag.span.0@text","ruleBookName":"h1.name@text","ruleBookAuthor":"class.author@text","ruleBookKind":"class.tags-box@text","ruleBookLastChapter":"id.updateTime@data-lc_name","ruleIntroduce":"class.comic-detail@tag.p.0@text","ruleCoverUrl":".cover-bg img@data-src","ruleChapterList":":_H006_2y4nNRMx4yEm7SPZGKnRNDm7aN83w2VGIHqS+sJ/Mu0=\n","ruleChapterName":"title","ruleChapterUrl":"","ruleContentUrl":"href","ruleBookContent":":_H006_\n"};
